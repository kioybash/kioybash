...
🔵  [**Анализ данных**](https://github.com/kioybash/analytical_tasks "**анализу данных**") - в данной работе были написаны SQL-запросы и произведена визуализация их результатов с помощью графиков в Redash.
...
🔵  [**Инженерия данных**](https://github.com/kioybash/data_engineer_portfolio "**инженерии данных**") - здесь представлены проекты выполненные в проекте обучения. 
